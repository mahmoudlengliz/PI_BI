...
package local_project.dimmeteo_0_1;
 ...
 * @status
 */
public class dimmeteo implements TalendJob {
	...
	private final String jobName = "dimmeteo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dimmeteo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_dimmeteo = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_dimmeteo = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_dimmeteo.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_dimmeteo.length == 0) {
						commonByteArray_LOCAL_PROJECT_dimmeteo = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_dimmeteo = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_dimmeteo, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_dimmeteo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_dimmeteo, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_dimmeteo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_dimmeteo) {
	...
	public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
		...
		public Integer skmeteo;

		public Integer getSkmeteo() {
			return this.skmeteo;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.skmeteo == null) ? 0 : this.skmeteo.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.skmeteo == null) {
				if (other.skmeteo != null)
					return false;

			} else if (!this.skmeteo.equals(other.skmeteo))
		...
		public int compareTo(out2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.skmeteo, other.skmeteo);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:tADDcbsW7hNw4JxCO3EOsZC3rLZ/4CFQRTIT8IXKWY9eHg==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "dimmeteoo";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "dimmeteoo";
				}
				int count_tDBOutput_1 = 0;

				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([fkzone_id],[station_id],[pluie_forte],[pluie_intense],[mois_gel],[risque_verglas],[risque_neige],[categories_meteo],[fkmois_id]) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:oZfhge2B1D+iGiIAL/27yvYkLrZICcmV8BpKguHDNc6Gkw==");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = "dimmeteoo";
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "dimmeteoo";
				}
				int count_tDBOutput_2 = 0;

				String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2
						+ "] SET [fkzone_id] = ?,[station_id] = ?,[pluie_forte] = ?,[pluie_intense] = ?,[mois_gel] = ?,[risque_verglas] = ?,[risque_neige] = ?,[categories_meteo] = ?,[fkmois_id] = ? WHERE [skmeteo] = ?";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:25vNJWDfv9MSjBe/tuPRh6rAxkARjSEobV6IX0X75ppeSg==");
				...
				String dbquery_tDBInput_1 = "SELECT dbo.stagingmete.zone_id,\n		dbo.stagingmete.zone,\n		dbo.stagingmete.station_id,\n		dbo.stagingmete.annee,\n		dbo.st"
						+ "agingmete.mois,\n		dbo.stagingmete.date,\n		dbo.stagingmete.temp_moy,\n		dbo.stagingmete.precipitation_mm,\n		dbo.stagingmet"
						+ "e.jours_pluie,\n		dbo.stagingmete.jours_gel_scrape,\n		dbo.stagingmete.jours_forte_gelee,\n		dbo.stagingmete.jours_sans_deg"
						+ "el,\n		dbo.stagingmete.jours_forte_chaleur,\n		dbo.stagingmete.pluie_forte,\n		dbo.stagingmete.pluie_intense,\n		dbo.staging"
						+ "mete.mois_gel,\n		dbo.stagingmete.risque_verglas,\n		dbo.stagingmete.risque_neige,\n		dbo.stagingmete.categories_meteo,\n		d"
						+ "bo.stagingmete.url,\n		dbo.stagingmete.date_collecte\nFROM	dbo.stagingmete";
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.station_id = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.station_id = tmpContent_tDBInput_1;
								}
							} else {
								row1.station_id = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.temp_moy = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.temp_moy = tmpContent_tDBInput_1;
								}
							} else {
								row1.temp_moy = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.precipitation_mm = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.precipitation_mm = tmpContent_tDBInput_1;
								}
							} else {
								row1.precipitation_mm = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.jours_pluie = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.jours_pluie = tmpContent_tDBInput_1;
								}
							} else {
								row1.jours_pluie = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 10) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.jours_gel_scrape = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.jours_gel_scrape = tmpContent_tDBInput_1;
								}
							} else {
								row1.jours_gel_scrape = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 11) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.jours_forte_gelee = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.jours_forte_gelee = tmpContent_tDBInput_1;
								}
							} else {
								row1.jours_forte_gelee = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 12) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.jours_sans_degel = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.jours_sans_degel = tmpContent_tDBInput_1;
								}
							} else {
								row1.jours_sans_degel = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 13) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.jours_forte_chaleur = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.jours_forte_chaleur = tmpContent_tDBInput_1;
								}
							} else {
								row1.jours_forte_chaleur = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 14) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.pluie_forte = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.pluie_forte = tmpContent_tDBInput_1;
								}
							} else {
								row1.pluie_forte = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 15) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.pluie_intense = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.pluie_intense = tmpContent_tDBInput_1;
								}
							} else {
								row1.pluie_intense = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 16) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.mois_gel = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.mois_gel = tmpContent_tDBInput_1;
								}
							} else {
								row1.mois_gel = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 17) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.risque_verglas = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.risque_verglas = tmpContent_tDBInput_1;
								}
							} else {
								row1.risque_verglas = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 18) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.risque_neige = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.risque_neige = tmpContent_tDBInput_1;
								}
							} else {
								row1.risque_neige = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 19) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.categories_meteo = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.categories_meteo = tmpContent_tDBInput_1;
								}
							} else {
								row1.categories_meteo = null;
							}
...
// # Filter conditions 
							...
							row4.skmeteo == null
								...
								out1_tmp.pluie_forte = row1.pluie_forte != null && row1.pluie_forte.equals("1");
								out1_tmp.pluie_intense = row1.pluie_intense != null && row1.pluie_intense.equals("1");
								out1_tmp.mois_gel = row1.mois_gel != null && row1.mois_gel.equals("1");
								out1_tmp.risque_verglas = row1.risque_verglas != null
										&& row1.risque_verglas.equals("1");
								out1_tmp.risque_neige = row1.risque_neige != null && row1.risque_neige.equals("1");
								out1_tmp.categories_meteo = row1.categories_meteo;
								out1_tmp.fkmois_id = row2.mois_id;
								out1 = out1_tmp;
...
// # Filter conditions 
							...
							row4.skmeteo != null
								...
								out2_tmp.fkzone_id = row3.zone_id;
								out2_tmp.station_id = row1.station_id;
								out2_tmp.pluie_forte = row1.pluie_forte != null && row1.pluie_forte.equals("1");
								out2_tmp.pluie_intense = row1.pluie_intense != null && row1.pluie_intense.equals("1");
								out2_tmp.mois_gel = row1.mois_gel != null && row1.mois_gel.equals("1");
								out2_tmp.risque_verglas = row1.risque_verglas != null
										&& row1.risque_verglas.equals("1");
								out2_tmp.risque_neige = row1.risque_neige != null && row1.risque_neige.equals("1");
								out2_tmp.categories_meteo = row1.categories_meteo;
								out2_tmp.fkmois_id = row2.mois_id;
								out2_tmp.skmeteo = row4.skmeteo;
								out2 = out2_tmp;
							} // closing filter/reject
// ###############################
...
// Start of branch "out2"
						if (out2 != null) {
							...
							if (out2.fkzone_id == null) {
								...
								pstmt_tDBOutput_2.setInt(1, out2.fkzone_id);
							}

							if (out2.station_id == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, out2.station_id);
							}

							if (out2.pluie_forte == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.BOOLEAN);
							} else {
								pstmt_tDBOutput_2.setBoolean(3, out2.pluie_forte);
							}

							if (out2.pluie_intense == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.BOOLEAN);
							} else {
								pstmt_tDBOutput_2.setBoolean(4, out2.pluie_intense);
							}

							if (out2.mois_gel == null) {
								pstmt_tDBOutput_2.setNull(5, java.sql.Types.BOOLEAN);
							} else {
								pstmt_tDBOutput_2.setBoolean(5, out2.mois_gel);
							}

							if (out2.risque_verglas == null) {
								pstmt_tDBOutput_2.setNull(6, java.sql.Types.BOOLEAN);
							} else {
								pstmt_tDBOutput_2.setBoolean(6, out2.risque_verglas);
							}

							if (out2.risque_neige == null) {
								pstmt_tDBOutput_2.setNull(7, java.sql.Types.BOOLEAN);
							} else {
								pstmt_tDBOutput_2.setBoolean(7, out2.risque_neige);
							}

							if (out2.categories_meteo == null) {
								pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(8, out2.categories_meteo);
							}

							pstmt_tDBOutput_2.setInt(9, out2.fkmois_id);

							if (out2.skmeteo == null) {
								pstmt_tDBOutput_2.setNull(10 + count_tDBOutput_2, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(10 + count_tDBOutput_2, out2.skmeteo);
							}
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XLBhmzo/GNxgC9tx1WP6fiL7tPBYruz/lqL7UFKCSBf5vw==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:UebGBbVMVXflgKQUoy78mRoN2xgAIeP2ffvdOMLsCmKytA==");
	...
	public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.fkzone_id = readInteger(dis, ois);
				...
				this.skmeteo = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.fkzone_id = readInteger(dis, objectIn);
				...
				this.fkmois_id = objectIn.readInt();

				this.skmeteo = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.fkzone_id, dos, oos);
				...
				writeInteger(this.skmeteo, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.fkzone_id, dos, objectOut);
				...
				objectOut.writeInt(this.fkmois_id);

				writeInteger(this.skmeteo, dos, objectOut);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:juy70v7q0hVS1CiIRgJ6POAoi0SzRUbnOewqRYyzmvz2zw==");
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							...
							row4.fkzone_id = rs_tDBInput_4.getInt(1);
						...
						if (colQtyInRs_tDBInput_4 < 3) {
							row4.pluie_forte = null;
						} else {

							row4.pluie_forte = rs_tDBInput_4.getBoolean(3);
							if (rs_tDBInput_4.wasNull()) {
								row4.pluie_forte = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 4) {
							row4.pluie_intense = null;
						} else {

							row4.pluie_intense = rs_tDBInput_4.getBoolean(4);
							if (rs_tDBInput_4.wasNull()) {
								row4.pluie_intense = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 5) {
							...
							row4.mois_gel = rs_tDBInput_4.getBoolean(5);
							if (rs_tDBInput_4.wasNull()) {
								row4.mois_gel = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 6) {
							row4.risque_verglas = null;
						} else {

							row4.risque_verglas = rs_tDBInput_4.getBoolean(6);
							if (rs_tDBInput_4.wasNull()) {
								row4.risque_verglas = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 7) {
							row4.risque_neige = null;
						} else {

							row4.risque_neige = rs_tDBInput_4.getBoolean(7);
							if (rs_tDBInput_4.wasNull()) {
								row4.risque_neige = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 8) {
							row4.categories_meteo = null;
						} else {
							...
							if (tmpContent_tDBInput_4 != null) {
								if (talendToDBList_tDBInput_4.contains(
									...
									row4.categories_meteo = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
								} else {
									row4.categories_meteo = tmpContent_tDBInput_4;
								}
							} else {
								row4.categories_meteo = null;
							}
						...
						if (colQtyInRs_tDBInput_4 < 9) {
							...
							row4.fkmois_id = rs_tDBInput_4.getInt(9);
							if (rs_tDBInput_4.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_4 < 10) {
							...
							row4.skmeteo = rs_tDBInput_4.getInt(10);
							if (rs_tDBInput_4.wasNull()) {
								row4.skmeteo = null;
							}
						}
						...
						row4_HashRow.fkzone_id = row4.fkzone_id;

						row4_HashRow.station_id = row4.station_id;

						row4_HashRow.pluie_forte = row4.pluie_forte;

						row4_HashRow.pluie_intense = row4.pluie_intense;

						row4_HashRow.mois_gel = row4.mois_gel;

						row4_HashRow.risque_verglas = row4.risque_verglas;

						row4_HashRow.risque_neige = row4.risque_neige;

						row4_HashRow.categories_meteo = row4.categories_meteo;

						row4_HashRow.fkmois_id = row4.fkmois_id;

						row4_HashRow.skmeteo = row4.skmeteo;
	...
	public static void main(String[] args) {
		final dimmeteo dimmeteoClass = new dimmeteo();

		int exitCode = dimmeteoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimmeteo.class.getClassLoader()
					.getResourceAsStream("local_project/dimmeteo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimmeteo.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimmeteo");
		}
...
/************************************************************************************************
 * 221492 characters generated by Talend Open Studio for Data Integration on the
 * 1 mars 2026 à 14:57:29 WAT
 ************************************************************************************************/