...
package local_project.stagingdelinquance_0_1;
...
/**
 * Job: stagingdelinquance Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class stagingdelinquance implements TalendJob {
	...
	private final String jobName = "stagingdelinquance";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					stagingdelinquance.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(stagingdelinquance.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_stagingdelinquance = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_stagingdelinquance = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_stagingdelinquance.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_stagingdelinquance.length == 0) {
						commonByteArray_LOCAL_PROJECT_stagingdelinquance = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_stagingdelinquance = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_stagingdelinquance, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_stagingdelinquance, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_stagingdelinquance, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_stagingdelinquance, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_stagingdelinquance) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:T9rgjqFi6tvbry1HOUEEgXxImWMPzeW26iUTffYUAp0UGw==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "stagingdelinquance";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "stagingdelinquance";
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([crime_id],[zone_id],[periode_mois],[annee],[mois],[categorie],[volume],[taux_pour_1000]) VALUES (?,?,?,?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:c/DqvJPUc4b2JE9+b2TJ1PD6lghy6XnkulSKnw==");
				...
				Object source_tFileInputExcel_1 = "C:/OneDrive_2026-01-21/Urban Mobility/data/delinquance.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "crime_id";

									row1.crime_id = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.crime_id = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "zone_id";

									row1.zone_id = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.zone_id = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "periode_mois";

									row1.periode_mois = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "volume";

									row1.volume = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.volume = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "taux_pour_1000";

									row1.taux_pour_1000 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.taux_pour_1000 = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.crime_id == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, row1.crime_id);
								}

								if (row1.zone_id == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, row1.zone_id);
								}

								if (row1.periode_mois == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.periode_mois);
								}
								...
								if (row1.categorie == null) {
									...
									pstmt_tDBOutput_1.setString(6, row1.categorie);
								}

								if (row1.volume == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, row1.volume);
								}

								if (row1.taux_pour_1000 == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(8, row1.taux_pour_1000);
								}
	...
	public static void main(String[] args) {
		final stagingdelinquance stagingdelinquanceClass = new stagingdelinquance();

		int exitCode = stagingdelinquanceClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = stagingdelinquance.class.getClassLoader()
					.getResourceAsStream("local_project/stagingdelinquance_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = stagingdelinquance.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : stagingdelinquance");
		}
...
/************************************************************************************************
 * 63251 characters generated by Talend Open Studio for Data Integration on the
 * 8 février 2026 à 23:47:01 WAT
 ************************************************************************************************/