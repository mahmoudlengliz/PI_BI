...
package local_project.dimactivity_0_1;
 ...
 * @status
 */
public class dimactivity implements TalendJob {
	...
	private final String jobName = "dimactivity";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dimactivity.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_dimactivity = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_dimactivity = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_dimactivity.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_dimactivity.length == 0) {
						commonByteArray_LOCAL_PROJECT_dimactivity = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_dimactivity = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_dimactivity, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_dimactivity, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_dimactivity, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_dimactivity, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_dimactivity) {
	...
	public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
		...
		public Integer skactivity;

		public Integer getSkactivity() {
			return this.skactivity;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.skactivity == null) ? 0 : this.skactivity.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.skactivity == null) {
				if (other.skactivity != null)
					return false;

			} else if (!this.skactivity.equals(other.skactivity))
		...
		public void copyDataTo(out2Struct other) {
			...
			other.skactivity = this.skactivity;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_dimactivity) {
				...
				try {
					...
					this.skactivity = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.skactivity, dos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("skactivity=" + String.valueOf(skactivity));
			sb.append(",activity_type=" + activity_type);
			sb.append("]");
		...
		public int compareTo(out2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.skactivity, other.skactivity);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		public String emission_factor;

		public String getEmission_factor() {
			return this.emission_factor;
		}

		public String co2_kg;

		public String getCo2_kg() {
			return this.co2_kg;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_dimactivity) {
				...
				try {
					...
					this.emission_id = readString(dis);
					...
					this.activity_value = readString(dis);

					this.emission_factor = readString(dis);

					this.co2_kg = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.emission_id, dos);
				...
				writeString(this.activity_value, dos);

				// String

				writeString(this.emission_factor, dos);

				// String

				writeString(this.co2_kg, dos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("emission_id=" + emission_id);
			sb.append(",annee=" + annee);
			sb.append(",mois=" + mois);
			sb.append(",zone_id=" + zone_id);
			sb.append(",mode=" + mode);
			sb.append(",activity_type=" + activity_type);
			sb.append(",activity_value=" + activity_value);
			sb.append(",emission_factor=" + emission_factor);
			sb.append(",co2_kg=" + co2_kg);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:KebdF/K7XaQ8/NYko3j9afpGWzcOYvhrhx1EQwxUqqypaA==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "dimactivite";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "dimactivite";
				}
				int count_tDBOutput_1 = 0;

				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([activity_type]) VALUES (?)";
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:IYQAAOAZbGJLdlkC1CxazrOPs7qJAPVuGfZDAjcve+PFEw==");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = "dimactivite";
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "dimactivite";
				}
				int count_tDBOutput_2 = 0;

				String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2
						+ "] SET [activity_type] = ? WHERE [skactivity] = ?";
...
// ###############################
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result
									+ ((this.activity_type == null) ? 0 : this.activity_type.hashCode());
					...
					public boolean equals(Object obj) {
						...
						} else if (!this.activity_type.equals(other.activity_type))
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:0Hi2HVoNNIVSxkSGQOTQEwrv8L72uDzzmVsHbB/x9Emgeg==");
				...
				String dbquery_tDBInput_1 = "SELECT dbo.stagingemissions_co2.emission_id,\n		dbo.stagingemissions_co2.annee,\n		dbo.stagingemissions_co2.mois,\n		dbo.s"
						+ "tagingemissions_co2.zone_id,\n		dbo.stagingemissions_co2.mode,\n		dbo.stagingemissions_co2.activity_type,\n		dbo.stagingemi"
						+ "ssions_co2.activity_value,\n		dbo.stagingemissions_co2.emission_factor,\n		dbo.stagingemissions_co2.co2_kg\nFROM	dbo.stagin"
						+ "gemissions_co2";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.emission_id = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.emission_id = tmpContent_tDBInput_1;
								}
							} else {
								row1.emission_id = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.activity_type = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.activity_type = tmpContent_tDBInput_1;
								}
							} else {
								row1.activity_type = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.activity_value = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.activity_value = tmpContent_tDBInput_1;
								}
							} else {
								row1.activity_value = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.emission_factor = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.emission_factor = tmpContent_tDBInput_1;
								}
							} else {
								row1.emission_factor = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.co2_kg = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.co2_kg = tmpContent_tDBInput_1;
								}
							} else {
								row1.co2_kg = null;
							}
						...
						row2 = null;
						finder_tUniqRow_1.activity_type = row1.activity_type;
						finder_tUniqRow_1.hashCodeDirty = true;
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

							new_tUniqRow_1.activity_type = row1.activity_type;
							...
							row2.emission_id = row1.emission_id;
							row2.annee = row1.annee;
							row2.mois = row1.mois;
							row2.zone_id = row1.zone_id;
							row2.mode = row1.mode;
							row2.activity_type = row1.activity_type;
							row2.activity_value = row1.activity_value;
							row2.emission_factor = row1.emission_factor;
							row2.co2_kg = row1.co2_kg;
...
// Start of branch "row2"
						if (row2 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row3HashKey.activity_type = row2.activity_type;
							...
							if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row3.activity_type = '" +
								// row3HashKey.activity_type + "'");
							} // G 071
...
// # Filter conditions 
								...
								row3.skactivity == null

								) {
									out1_tmp.activity_type = row2.activity_type;
									out1 = out1_tmp;
...
// # Filter conditions 
								...
								row3.skactivity != null
									...
									out2_tmp.skactivity = row3.skactivity;
									out2_tmp.activity_type = row2.activity_type;
									out2 = out2_tmp;
								} // closing filter/reject
// ###############################
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (out1.activity_type == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, out1.activity_type);
								}
...
// Start of branch "out2"
							if (out2 != null) {
								...
								if (out2.activity_type == null) {
									pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(1, out2.activity_type);
								}

								if (out2.skactivity == null) {
									pstmt_tDBOutput_2.setNull(2 + count_tDBOutput_2, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(2 + count_tDBOutput_2, out2.skactivity);
								}
...
// ###############################      
	...
	public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.activity_type == null) ? 0 : this.activity_type.hashCode());
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.skactivity = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.skactivity = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.skactivity, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.skactivity, dos, objectOut);
		...
		public int compareTo(row3Struct other) {
			...
			returnValue = checkNullsAndCompare(this.activity_type, other.activity_type);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row2,row3) outputs:(out1,out2)
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:rw8MKor2Nl0TL+tVeLsAeqha5f56XinftZvbtpT6vJE+Ew==");
				...
				String dbquery_tDBInput_2 = "SELECT dimactivite.activity_type,\n		dimactivite.skactivity\nFROM	dimactivite";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row3.activity_type = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.activity_type = tmpContent_tDBInput_2;
								}
							} else {
								row3.activity_type = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row3.skactivity = rs_tDBInput_2.getInt(2);
						...
						row3_HashRow.activity_type = row3.activity_type;

						row3_HashRow.skactivity = row3.skactivity;
	...
	public static void main(String[] args) {
		final dimactivity dimactivityClass = new dimactivity();

		int exitCode = dimactivityClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimactivity.class.getClassLoader()
					.getResourceAsStream("local_project/dimactivity_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimactivity.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimactivity");
		}
...
/************************************************************************************************
 * 127160 characters generated by Talend Open Studio for Data Integration on the
 * 1 mars 2026 à 12:17:35 WAT
 ************************************************************************************************/