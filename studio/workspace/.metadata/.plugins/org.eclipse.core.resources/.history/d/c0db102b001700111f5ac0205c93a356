...
package local_project.staginglignesndjson_0_1;
...
/**
 * Job: staginglignesndjson Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class staginglignesndjson implements TalendJob {
	...
	private final String jobName = "staginglignesndjson";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					staginglignesndjson.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(staginglignesndjson.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_staginglignesndjson = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_staginglignesndjson = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_staginglignesndjson.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_staginglignesndjson.length == 0) {
						commonByteArray_LOCAL_PROJECT_staginglignesndjson = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_staginglignesndjson = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_staginglignesndjson, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_staginglignesndjson, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_staginglignesndjson, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_staginglignesndjson, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_staginglignesndjson) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:WQ3speu9ObIDFocDZOX7qZvQjeukUOVRipKPEaPctkY4sg==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "stanginglignesnd";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "stanginglignesnd";
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([line_id],[line_nom],[mode],[operateur],[couleur],[actif],[created_at]) VALUES (?,?,?,?,?,?,?)";
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						"C:/OneDrive_2026-01-21/Urban Mobility/data/lignes.ndjson"/**
																					 * End field
						...
						try {
							...
							if (rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.line_nom = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.mode = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.operateur = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row1.actif = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row1.line_id != null) {// C_01
								jsonStr_tExtractJSONFields_1 = row1.line_id.toString();
								...
								for (int i_tExtractJSONFields_1 = 0; isStructError_tExtractJSONFields_1
									...
									if (!isStructError_tExtractJSONFields_1) {
										...
										try {
											jsonPath_tExtractJSONFields_1 = "$.line_id";
											...
											try {
												...
												row2.line_id = value_tExtractJSONFields_1 == null ?
											...
											jsonPath_tExtractJSONFields_1 = "$.line_nom";
											compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
													.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
											...
											try {
												...
												row2.line_nom = value_tExtractJSONFields_1 == null ?
											...
											jsonPath_tExtractJSONFields_1 = "$.mode";
											compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
													.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
											...
											try {
												...
												row2.mode = value_tExtractJSONFields_1 == null ?
											...
											jsonPath_tExtractJSONFields_1 = "$.operateur";
											compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
													.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
											...
											try {
												...
												row2.operateur = value_tExtractJSONFields_1 == null ?
											...
											jsonPath_tExtractJSONFields_1 = "$.couleur";
											compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
													.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
											...
											try {
												...
												row2.couleur = value_tExtractJSONFields_1 == null ?
											...
											jsonPath_tExtractJSONFields_1 = "$.actif";
											compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
													.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
											...
											try {
												...
												row2.actif = value_tExtractJSONFields_1 == null ?
											...
											jsonPath_tExtractJSONFields_1 = "$.created_at";
											compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
													.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
											...
											try {
												...
												row2.created_at = value_tExtractJSONFields_1 == null ?
...
// Start of branch "row2"
									if (row2 != null) {
										...
										if (row2.line_id == null) {
											...
											pstmt_tDBOutput_1.setString(1, row2.line_id);
										}

										if (row2.line_nom == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, row2.line_nom);
										}

										if (row2.mode == null) {
											pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(3, row2.mode);
										}

										if (row2.operateur == null) {
											pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(4, row2.operateur);
										}

										if (row2.couleur == null) {
											pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(5, row2.couleur);
										}

										if (row2.actif == null) {
											pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(6, row2.actif);
										}

										if (row2.created_at == null) {
											pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(7, row2.created_at);
										}
	...
	public static void main(String[] args) {
		final staginglignesndjson staginglignesndjsonClass = new staginglignesndjson();

		int exitCode = staginglignesndjsonClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = staginglignesndjson.class.getClassLoader().getResourceAsStream(
					"local_project/staginglignesndjson_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = staginglignesndjson.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : staginglignesndjson");
		}
...
/************************************************************************************************
 * 76924 characters generated by Talend Open Studio for Data Integration on the
 * 8 février 2026 à 23:44:21 WAT
 ************************************************************************************************/