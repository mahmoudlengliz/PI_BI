...
public class TFileInputXMLEndJava
{
  ...
  protected final String TEXT_24 = NL + "\ttry {" + NL + "\t\tlooper_";
  protected final String TEXT_25 = ".handleTaskResponse();" + NL + "\t} catch(java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_26 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "\t\tif(!(e.getCause() instanceof org.talend.xml.sax.exception.EnoughDataException))" + NL + "\t";
  ...
  protected final String TEXT_31 = NL + "\t\tSystem.err.println(e.getMessage());\t" + NL + "\t";
