...
public class TFileInputXMLBeginJava
{
  ...
  protected final String TEXT_317 = NL + "\tif(xml_api_";
  protected final String TEXT_318 = ".getNodeType(tmp_";
  protected final String TEXT_319 = ")==org.apache.xpath.objects.XObject.CLASS_NODESET){" + NL + "\t\tnode_";
  protected final String TEXT_320 = ".getSingleNode(tmp_";
  protected final String TEXT_321 = NL + "    \tif(node_";
  protected final String TEXT_322 = "!=null && node_";
  protected final String TEXT_323 = ".getNodeType()==org.w3c.dom.Node.ELEMENT_NODE && node_";
  protected final String TEXT_324 = ".hasChildNodes()){" + NL + "    \t\tstr_";
  protected final String TEXT_325 = " = contentTool_";
  protected final String TEXT_326 = ".getNodeContent(node_";
  protected final String TEXT_327 = ");" + NL + "    \t}else{" + NL + "    \t\tstr_";
  protected final String TEXT_328 = " = node_";
  protected final String TEXT_329 = "!=null?node_";
  protected final String TEXT_330 = ".getTextContent():\"\";" + NL + "    \t}";
  protected final String TEXT_331 = NL + "\t\tstr_";
  protected final String TEXT_332 = ".getTextContent():\"\";";
  protected final String TEXT_333 = NL + "\t}else{" + NL + "\t\tnode_";
  protected final String TEXT_334 = " = tmp_";
  protected final String TEXT_335 = ";" + NL + "\t\tstr_";
  protected final String TEXT_336 = ".getNodeString(tmp_";
  protected final String TEXT_337 = ");" + NL + "\t}";
  protected final String TEXT_338 = NL + "\tif(true) {" + NL + "\t\tthrow new RuntimeException(\"Error Config: \\\"Get Nodes\\\" should be checked when type is \\\"Document\\\"\");" + NL + "\t}";
  protected final String TEXT_339 = NL + "    Object obj";
  protected final String TEXT_340 = "_";
  protected final String TEXT_341 = " = xpaths_";
  ...
  protected final String TEXT_345 = " == null) {" + NL + "    \tnode_";
  protected final String TEXT_346 = NL + "    \tstr_";
  protected final String TEXT_347 = " = \"\";";
  protected final String TEXT_348 = NL + "    \t" + NL + "    } else if(obj";
  protected final String TEXT_349 = " instanceof org.dom4j.Node) {" + NL + "    \tnode_";
  protected final String TEXT_350 = " = (org.dom4j.Node)obj";
  protected final String TEXT_351 = ".asXML();";
  protected final String TEXT_352 = " = org.jaxen.function.StringFunction.evaluate(node_";
  ...
  protected final String TEXT_355 = " instanceof String || obj";
  ...
  protected final String TEXT_360 = ");" + NL + "    } else if(obj";
  protected final String TEXT_361 = " instanceof java.util.List){" + NL + "    \tjava.util.List<org.dom4j.Node> nodes_";
  protected final String TEXT_362 = " = (java.util.List<org.dom4j.Node>)obj";
  protected final String TEXT_363 = ";" + NL + "    \tnode_";
  protected final String TEXT_364 = " = nodes_";
  protected final String TEXT_365 = ".size()>0 ? nodes_";
  protected final String TEXT_366 = ".get(0) : null;";
  protected final String TEXT_367 = "==null?null:node_";
  protected final String TEXT_368 = "==null?\"\":org.jaxen.function.StringFunction.evaluate(node_";
  protected final String TEXT_369 = NL + "\t}";
  protected final String TEXT_370 = NL + "\tstr_";
  protected final String TEXT_371 = " = row_";
  protected final String TEXT_372 = NL + "\tnode_";
  protected final String TEXT_373 = " = new String[]{str_";
  protected final String TEXT_374 = ",row_";
  protected final String TEXT_375 = "+\"/@xsi:nil\")};";
  protected final String TEXT_376 = ",null};";
  protected final String TEXT_377 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_378 = ".";
  protected final String TEXT_379 = " = ParserUtils.parseTo_Document(str_";
  protected final String TEXT_380 = " = str_";
  protected final String TEXT_381 = NL + "\t\t\t\t\t\t\t\t\tif(xml_api_";
  protected final String TEXT_382 = ".isDefNull(node_";
  protected final String TEXT_383 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_384 = " =null;" + NL + "\t\t\t\t\t\t\t\t\t}else if(xml_api_";
  protected final String TEXT_385 = ".isEmpty(node_";
  protected final String TEXT_386 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_387 = " =\"\";" + NL + "\t\t\t\t\t\t\t\t\t}else if(xml_api_";
  protected final String TEXT_388 = ".isMissing(node_";
  ...
  protected final String TEXT_399 = " = ParserUtils.parseTo_Date(str_";
  protected final String TEXT_400 = ",false);";
  protected final String TEXT_401 = "\t\t\t\t\t\t\t" + NL + "\t\t";
  protected final String TEXT_402 = ".getBytes(";
  protected final String TEXT_403 = " = ParserUtils.parseTo_";
  protected final String TEXT_404 = "(ParserUtils.parseTo_Number(str_";
  protected final String TEXT_405 = "));";
  protected final String TEXT_406 = "(str_";
  protected final String TEXT_407 = NL + "    \t\t\t\t";
  protected final String TEXT_408 = NL + "\tboolean whetherReject_";
  protected final String TEXT_409 = " = false;" + NL + "\t";
  protected final String TEXT_410 = " = new ";
  protected final String TEXT_411 = "Struct();" + NL + "\ttry{";
  protected final String TEXT_412 = " = null; ";
  protected final String TEXT_413 = NL + "\t\t\t" + NL + "    } catch (java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_414 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "        whetherReject_";
  ...
  protected final String TEXT_418 = " - \" + e.getMessage());" + NL + "\t\t\t";
  ...
  protected final String TEXT_423 = NL + "                System.err.println(e.getMessage());";
  protected final String TEXT_424 = NL + "            \t";
  protected final String TEXT_425 = NL + "    }";
  protected final String TEXT_426 = "if(!whetherReject_";
  protected final String TEXT_427 = ") { ";
  protected final String TEXT_428 = "      " + NL + "             if(";
  protected final String TEXT_429 = " == null){ " + NL + "            \t ";
  protected final String TEXT_430 = "Struct();" + NL + "             }";
