...
package local_project.prix_carburants_0_1;
...
/**
 * Job: prix_carburants Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class prix_carburants implements TalendJob {
	...
	private final String jobName = "prix_carburants";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					prix_carburants.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(prix_carburants.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_prix_carburants = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_prix_carburants = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_prix_carburants.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_prix_carburants.length == 0) {
						commonByteArray_LOCAL_PROJECT_prix_carburants = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_prix_carburants = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_prix_carburants, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_prix_carburants, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_prix_carburants, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_prix_carburants, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_prix_carburants) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:IoBEOPe7SOuf2LzmfzmPwFpTa4xooL6C4jIYe/s2/8nlRQ==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "stagingprix_carburants";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "stagingprix_carburants";
				}
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:itzbKS+kJaywJs3hnw7fg9Ea5DaoGjwXOeoFHg==");
				...
				Object source_tFileInputExcel_1 = "C:/OneDrive_2026-01-21/Urban Mobility/data/prix_carburants.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "price_id";

									row1.price_id = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.price_id = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "fuel_type";

									row1.fuel_type = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.fuel_type = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "devise";

									row1.devise = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.devise = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
	...
	public static void main(String[] args) {
		final prix_carburants prix_carburantsClass = new prix_carburants();

		int exitCode = prix_carburantsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = prix_carburants.class.getClassLoader()
					.getResourceAsStream("local_project/prix_carburants_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = prix_carburants.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : prix_carburants");
		}
...
/************************************************************************************************
 * 63143 characters generated by Talend Open Studio for Data Integration on the
 * 8 février 2026 à 23:58:44 WAT
 ************************************************************************************************/