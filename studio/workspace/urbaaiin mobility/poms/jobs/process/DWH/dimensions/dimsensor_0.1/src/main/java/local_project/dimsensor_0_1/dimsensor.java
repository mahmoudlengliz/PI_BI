...
package local_project.dimsensor_0_1;
 ...
 * @status
 */
public class dimsensor implements TalendJob {
	...
	private final String jobName = "dimsensor";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dimsensor.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_dimsensor = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_dimsensor = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_dimsensor.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_dimsensor.length == 0) {
						commonByteArray_LOCAL_PROJECT_dimsensor = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_dimsensor = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_dimsensor, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_dimsensor, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_dimsensor, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_dimsensor, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_dimsensor) {
	...
	public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
		...
		public Integer sksensor;

		public Integer getSksensor() {
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.sksensor, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:UjLYlPSeuovfPatfR1hr4qhhpWi6iqT/eFHeCCz35DLOFQ==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "dimsensor";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "dimsensor";
				}
				int count_tDBOutput_1 = 0;

				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([nomsensor]) VALUES (?)";
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:qTW/po7WjML2vYZykx79WzG8WkAIW6iAjOpAlCuM5uTEJQ==");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = "dimsensor";
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "dimsensor";
				}
				int count_tDBOutput_2 = 0;

				String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2
						+ "] SET [nomsensor] = ? WHERE [sksensor] = ?";
...
// ###############################
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result
									+ ((this.source_sensor == null) ? 0 : this.source_sensor.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.source_sensor == null) {
							if (other.source_sensor != null)
								return false;

						} else if (!this.source_sensor.equals(other.source_sensor))
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:V04XrlS5+O0mxkUXG6toIh0bdlTXvBO00xNSXbFZa9KrWQ==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.trafic_id = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.trafic_id = tmpContent_tDBInput_1;
								}
							} else {
								row1.trafic_id = null;
							}
						...
						row3 = null;
						finder_tUniqRow_1.source_sensor = row1.source_sensor;
						finder_tUniqRow_1.hashCodeDirty = true;
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

							new_tUniqRow_1.source_sensor = row1.source_sensor;
							...
							row3.trafic_id = row1.trafic_id;
							row3.time_id = row1.time_id;
							row3.zone_id = row1.zone_id;
							row3.vitesse_kmh = row1.vitesse_kmh;
							row3.temps_trajet_min = row1.temps_trajet_min;
							row3.congestion_index = row1.congestion_index;
							row3.source_sensor = row1.source_sensor;
...
// Start of branch "row3"
						if (row3 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row2HashKey.nomsensor = row3.source_sensor;
							...
							if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row2.nomsensor = '" +
								// row2HashKey.nomsensor + "'");
							} // G 071
...
// # Filter conditions 
								...
								row2.sksensor == null
									...
									out1_tmp.nomsensor = (row3.source_sensor == null || row3.source_sensor.isEmpty())
											? "UNKNOWN"
											: row3.source_sensor;
									out1 = out1_tmp;
...
// # Filter conditions 
								...
								row2.sksensor != null
									...
									out2_tmp.nomsensor = (row3.source_sensor == null || row3.source_sensor.isEmpty())
											? "UNKNOWN"
											: row3.source_sensor;
									out2_tmp.sksensor = row2.sksensor;
									out2 = out2_tmp;
								} // closing filter/reject
// ###############################
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (out1.nomsensor == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, out1.nomsensor);
								}
...
// Start of branch "out2"
							if (out2 != null) {
								...
								if (out2.nomsensor == null) {
									pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(1, out2.nomsensor);
								}

								if (out2.sksensor == null) {
									pstmt_tDBOutput_2.setNull(2 + count_tDBOutput_2, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(2 + count_tDBOutput_2, out2.sksensor);
								}
...
// ###############################      
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.sksensor = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.sksensor = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.sksensor, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.sksensor, dos, objectOut);
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row3,row2) outputs:(out1,out2)
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:oiskOYvvQCjLrE6bYCKbqBXa2yb8x7/oJdhtw7G7oaGIDg==");
				...
				String dbquery_tDBInput_2 = "SELECT dimsensor.nomsensor,\n		dimsensor.sksensor\nFROM	dimsensor";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row2.nomsensor = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.nomsensor = tmpContent_tDBInput_2;
								}
							} else {
								row2.nomsensor = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row2.sksensor = rs_tDBInput_2.getInt(2);
						...
						row2_HashRow.nomsensor = row2.nomsensor;

						row2_HashRow.sksensor = row2.sksensor;
	...
	public static void main(String[] args) {
		final dimsensor dimsensorClass = new dimsensor();

		int exitCode = dimsensorClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dimsensor.class.getClassLoader()
					.getResourceAsStream("local_project/dimsensor_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dimsensor.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dimsensor");
		}
...
/************************************************************************************************
 * 122138 characters generated by Talend Open Studio for Data Integration on the
 * 28 février 2026 à 23:48:44 WAT
 ************************************************************************************************/