...
package urban_mobility.loadarretstostaging_0_1;
...
public class loadarretstostaging implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_URBAN_MOBILITY_loadarretstostaging = new byte[0];
		static byte[] commonByteArray_URBAN_MOBILITY_loadarretstostaging = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_URBAN_MOBILITY_loadarretstostaging.length) {
					if (length < 1024 && commonByteArray_URBAN_MOBILITY_loadarretstostaging.length == 0) {
						commonByteArray_URBAN_MOBILITY_loadarretstostaging = new byte[1024];
					} else {
						commonByteArray_URBAN_MOBILITY_loadarretstostaging = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_URBAN_MOBILITY_loadarretstostaging, 0, length);
				strReturn = new String(commonByteArray_URBAN_MOBILITY_loadarretstostaging, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_URBAN_MOBILITY_loadarretstostaging, 0, length);
				strReturn = new String(commonByteArray_URBAN_MOBILITY_loadarretstostaging, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_URBAN_MOBILITY_loadarretstostaging) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:r2TLQB5/JWc3Gvcv6VTkFHHZI/DPORGK3c2Y5wnrqwrsDBMDrFw=");
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						"C:/Users/mahmo/Downloads/data_pi/Urban Mobility/data/arrets.csv"/**
																							 * End field
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:k/oaWJuR4QBt0XgTEoGADgaFtciAjaOQOR268LWHjluBRGQiuXc=");
				...
				Object filename_tFileInputDelimited_4 = /** Start field tFileInputDelimited_4:FILENAME */
						"C:/Users/mahmo/Downloads/data_pi/Urban Mobility/data/segments.csv"/**
																							 * End field
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_7 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Rg7sKg/PkmU+wow007V9NDaU5zTGiPWtTqM8Q9CWXdMMeCriRrs=");
				...
				Object filename_tFileInputDelimited_7 = /** Start field tFileInputDelimited_7:FILENAME */
						"C:/Users/mahmo/Downloads/data_pi/Urban Mobility/data/trafic.csv"/**
																							 * End field
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object filename_tFileInputDelimited_8 = /** Start field tFileInputDelimited_8:FILENAME */
						"C:/Users/mahmo/Downloads/data_pi/Urban Mobility/data/transport_passages.csv"/**
																										 * End field
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.Statement stmtTruncCount_tDBOutput_9 = conn_tDBOutput_9.createStatement()) {
					try (java.sql.ResultSet rsTruncCount_tDBOutput_9 = stmtTruncCount_tDBOutput_9
							.executeQuery("SELECT COUNT(1) FROM [" + tableName_tDBOutput_9 + "]")) {
				...
				Object filename_tFileInputDelimited_9 = /** Start field tFileInputDelimited_9:FILENAME */
						"C:/Users/mahmo/Downloads/data_pi/Urban Mobility/data/vehicules.csv"/**
																							 * End field
					...
					while (limittFileInputDelimited_9 != 0 && csvReadertFileInputDelimited_9 != null
						...
						try {
							...
							if (rowtFileInputDelimited_9.length == 1 && ("\015").equals(rowtFileInputDelimited_9[0])) {// empty
								...
								row6.heure_theorique = null;

								row6.heure_reelle = null;

								row6.retard_s = null;

								row6.annule = null;

								row6.charge_estimee = null;
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row6.event_id = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row6.time_id = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row6.stop_id = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row6.heure_theorique = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row6.heure_reelle = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row6.retard_s = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row6.annule = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
								...
								if (columnIndexWithD_tFileInputDelimited_9 < rowtFileInputDelimited_9.length) {
									...
									row6.charge_estimee = rowtFileInputDelimited_9[columnIndexWithD_tFileInputDelimited_9];
...
// Start of branch "row6"
						if (row6 != null) {
							...
							if (row6.event_id == null) {
								pstmt_tDBOutput_9.setNull(1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(1, row6.event_id);
							}

							if (row6.time_id == null) {
								pstmt_tDBOutput_9.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(2, row6.time_id);
							}

							if (row6.line_id == null) {
								pstmt_tDBOutput_9.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(3, row6.line_id);
							}

							if (row6.stop_id == null) {
								pstmt_tDBOutput_9.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(4, row6.stop_id);
							}

							if (row6.heure_theorique == null) {
								pstmt_tDBOutput_9.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(5, row6.heure_theorique);
							}

							if (row6.heure_reelle == null) {
								pstmt_tDBOutput_9.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(6, row6.heure_reelle);
							}

							if (row6.retard_s == null) {
								pstmt_tDBOutput_9.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(7, row6.retard_s);
							}

							if (row6.annule == null) {
								pstmt_tDBOutput_9.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(8, row6.annule);
							}

							if (row6.charge_estimee == null) {
								pstmt_tDBOutput_9.setNull(9, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(9, row6.charge_estimee);
							}

							if (row6.vehicle_id == null) {
								pstmt_tDBOutput_9.setNull(10, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(10, row6.vehicle_id);
							}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object filename_tFileInputDelimited_10 = /** Start field tFileInputDelimited_10:FILENAME */
						"C:/Users/mahmo/Downloads/data_pi/Urban Mobility/data/zones.csv"/**
																						 * End field
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object filename_tFileInputDelimited_11 = /** Start field tFileInputDelimited_11:FILENAME */
						"C:/Users/mahmo/Downloads/data_pi/Urban Mobility/data/zones_latin1.csv"/**
																								 * End field
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = loadarretstostaging.class.getClassLoader().getResourceAsStream(
					"urban_mobility/loadarretstostaging_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 297521 characters generated by Talend Open Studio for Data Integration on the
 * February 21, 2026 at 11:54:41 AM GMT
 ************************************************************************************************/